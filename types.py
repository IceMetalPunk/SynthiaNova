...
class SongInfo(BaseModel):
    ...
    lyrics: str = Field(description="All the lyrics of the song. Do NOT, under any circumstances, include tags like [Chorus], [Verse], etc.; nor 'Chorus:', 'Verse:', etc.; nor any such markers! ONLY write the lyrics that will actually be sung! EXCLUDE structure markers! Avoid giving direction in the lyrics, only include lyrics; but if you must give a direction, put it in [square brackets] only. NEVER put actual lyrics in square brackets! Every line must be on its own line, separated by new line breaks! If the chorus is sung multiple times, write out its lyrics every time. Include any backing vocals or gang vocals if you like, including 'heys' and 'oohs', (in parentheses) where they should be sung. Stick to the emotion indicated by the topic and memories; don't try to put a positive spin on serious topics, and don't write too seriously about lighthearted topics. Feel free to be creative with your rhyme schemes, but make sure every song DOES have a discernible rhyme scheme!")
